...
class Widgets_Loader {
	...
	public function include_widgets_files() {
		...
		if ( class_exists( 'woocommerce' ) ) {
			require_once HFE_DIR . '/inc/widgets-manager/widgets/class-product-stock.php';
		}
	...
	public function register_widgets() {
		...
		if ( class_exists( 'woocommerce' ) ) {
			Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Product_Stock() );
		}
	}
